...
public class CameraView extends ViewGroup implements Camera.AutoFocusCallback {
            ...
            public void run() {
                if (camera == null) {
                    try {
                        ...
                        getCameraHost().onCameraFail(CameraHost.FailureReason.UNKNOWN);
                    }
                    ...
                    if (cameraId >= 0) {
                        ...
                        getCameraHost().onCameraFail(CameraHost.FailureReason.NO_CAMERAS_REPORTED);
                    }
                }
            }
        });
    ...
    public boolean doesZoomReallyWork() {
        ...
        return (getCameraHost().getDeviceProfile().doesZoomActuallyWork(info.facing == Camera.CameraInfo.CAMERA_FACING_FRONT));
    }
