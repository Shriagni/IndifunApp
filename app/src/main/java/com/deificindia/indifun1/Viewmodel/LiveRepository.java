...
public class LiveRepository {
    ...
    /*201026 new star india result @spario*/
    public MutableLiveData<NewstarModal> newstar_india(){
        MutableLiveData<NewstarModal> data = new MutableLiveData<>();
    ...
    public MutableLiveData<TrendingModal> trending(){
        MutableLiveData<TrendingModal> data = new MutableLiveData<>();
