...
public class URLs {
    ...
    public static final String URL_FOLLOW =BaseUrl+"follow_add" ;
    public static final String URL_FOLLOWPOST =BaseUrl+"follow_post" ;
    ...
    public static final String URL_CREATEPOST = BaseUrl+"add_post";
    ...
    public static final String GETFRIENDS =BaseUrl+"user_friends" ;
    public static final String GETFOLLOWING =BaseUrl+"user_following" ;
    public static final String GETFOLLOWERS =BaseUrl+"user_follower" ;
    public static final String GETGROUPS =BaseUrl+"user_groups_list" ;
}
