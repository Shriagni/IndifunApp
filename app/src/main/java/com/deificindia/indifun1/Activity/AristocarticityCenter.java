...
import com.deificindia.indifun1.Fragment.AristocracyCenterFragment;
...
import com.deificindia.indifun1.pojo.aristocracycenterpojo.ResultItem;
...
public class AristocarticityCenter extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_header_title.setText("Aristocracy Center");
        ...
        getaristocraticitycenter();
    }

    private void getaristocraticitycenter() {

        myDialog = DialogUtils.showProgressDialog(AristocarticityCenter.this, "Loading Please Wait...");
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URLs.INTERESTARISTOCRACITYCENTRLIST,
                new Response.Listener<String>() {
                            ...
                            if (obj.optInt("status") == 1) {
                                ...
                                if (resultItems != null && resultItems.size() > 0) {
                                    ...
                                    for (int i = 0; i < resultItems.size(); i++) {
                                        ...
                                        tabLayout.addTab(tabLayout.newTab().setText(resultItems.get(i).getTitle()));
                                    }
                  ...
                  /*  Toast.makeText(MainActivity.this,
                            "Selected page position: " + position, Toast.LENGTH_SHORT).show();*/
                                ...
                                Toast.makeText(AristocarticityCenter.this, obj.optString("message"), Toast.LENGTH_SHORT).show();
                            }
                        } catch (JSONException e) {
                            myDialog.dismiss();

                            Toast.makeText(AristocarticityCenter.this, getString(R.string.netwrokerrorpleasetryaftersometime), Toast.LENGTH_SHORT).show();
    ...
    public class MyPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            return AristocracyCenterFragment.newInstance(
                    Integer.parseInt(
                            resultItems1.get(position).getId())
                    ,resultItems1.get(position).getTitle(),
                    resultItems1.get(position).getImage());
            //   default:
            //    return null;
            //  }
        }
        ...
        public CharSequence getPageTitle(int position) {
            ...
            charSequence = resultItems1.get(position).getTitle();
