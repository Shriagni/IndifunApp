...
import com.deificindia.indifun1.pojo.broadcastwatchedpojo.ResultItem;
...
public class BroadcastsWatchActivity extends AppCompatActivity {
    ...
    private void deletebroadcast() {
        ...
        myDialog = DialogUtils.showProgressDialog(BroadcastsWatchActivity.this, "Loading Please Wait...");
    ...
    private class BroadcastsWatchAdapter extends RecyclerView.Adapter<BroadcastsWatchAdapter.ViewHolder> {
        ...
        @NonNull
        @Override
        public BroadcastsWatchAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View v = null;
            ...
            return new BroadcastsWatchAdapter.ViewHolder(v);
        }

        @Override
        public void onBindViewHolder(@NonNull BroadcastsWatchAdapter.ViewHolder holder, final int position) {


            holder.username.setText(resultItems1.get(position).getUserName());
            ...
            try {
                ...
                Date d = f.parse(resultItems1.get(position).getEntryTime());
            ...
            if (resultItems1.get(position).getUserImage() != null && !resultItems1.get(position).getUserImage().isEmpty()) {
                ...
                Picasso.get()
                        .load(URLs.UserImageBaseUrl + resultItems1.get(position).getUserImage())
        ...
        private void deletebroadcastindividual(String id1) {
