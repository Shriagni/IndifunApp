...
import com.deificindia.indifun1.pojo.stickerspojo.ResultItem;
...
public class StickerActivity extends AppCompatActivity {
    ...
    private class StickerAdapter extends RecyclerView.Adapter<StickerAdapter.ViewHolder> {
        ...
        public StickerAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            ...
            return new StickerAdapter.ViewHolder(v);
        }

        @Override
        public void onBindViewHolder(@NonNull StickerAdapter.ViewHolder holder, final int position) {
