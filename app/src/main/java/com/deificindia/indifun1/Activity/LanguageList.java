...
import com.deificindia.indifun1.pojo.alllangaugespojo.ResultItem;
...
public class LanguageList extends AppCompatActivity {
    ...
    private ArrayList<com.deificindia.indifun1.pojo.userlangpojo.ResultItem> userresultItems = new ArrayList<>();
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (obj.optInt("status") == 1) {
                                ...
                                for (int i = 0; i < jsonObject.length(); i++) {
                                    JSONObject qstnArray = jsonObject.getJSONObject(i);
                                    com.deificindia.indifun1.pojo.userlangpojo.ResultItem resultItem = new com.deificindia.indifun1.pojo.userlangpojo.ResultItem();
                                    resultItem.setId(qstnArray.getString("id"));
    ...
    private class LanguagesAdapter extends RecyclerView.Adapter<LanguagesAdapter.ViewHolder> {
        ...
        @Override
        public void onBindViewHolder(@NonNull LanguagesAdapter.ViewHolder holder, final int position) {
        ...
        private void updatelanguage(LanguagesAdapter.ViewHolder holder,final int position1, final String langid) {
            Dialog myDialog;
            Progress_Dialogue DialogUtils = null;
            myDialog = DialogUtils.showProgressDialog(LanguageList.this, "Loading Please Wait...");
        ...
        private void unchecklanguage(LanguagesAdapter.ViewHolder holder,final int position1, final String langid) {
            Dialog myDialog;
            Progress_Dialogue DialogUtils = null;
            myDialog = DialogUtils.showProgressDialog(LanguageList.this, "Loading Please Wait...");
