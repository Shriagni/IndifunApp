...
public class StreamContent {
    ...
    public static String TAG = "StreamContent";
    ...
    //Get an Int PROPERTY from the red5config.xmlg.xml - localProperty has preference
    ...
    //Get an String PROPERTY from the red5configonfig.xml - localProperty has preference
