...
public class InviteUserActionSheet extends AbstractActionSheet {
    ...
    public void append(List<AudienceListResponse.AudienceInfo> userList) {
        mAdapter.append(userList);
    }

    private class RoomUserAdapter extends RecyclerView.Adapter<RoomUserViewHolder> {
        private List<AudienceListResponse.AudienceInfo> mUserList = new ArrayList<>();

        void append(List<AudienceListResponse.AudienceInfo> userList) {
        ...
        public void onBindViewHolder(@NonNull RoomUserViewHolder holder, final int position) {
            AudienceListResponse.AudienceInfo info = mUserList.get(position);
