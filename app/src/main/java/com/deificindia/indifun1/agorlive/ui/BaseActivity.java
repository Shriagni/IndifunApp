package com.deificindia.indifun1.agorlive.ui;
...
import com.deificindia.indifun1.dialogs.GiftBottomSheetDialog;
...
import com.deificindia.indifun1.agorlive.ui.actionsheets.AbstractActionSheet;
...
public abstract class BaseActivity extends AppCompatActivity implements ClientProxyListener {
    ...
    protected Dialog showDialog(int title, int message, final View.OnClickListener positiveClickListener) {
    ...
    public IndifunApplication application() {
        return (IndifunApplication)  getApplication();
    }
