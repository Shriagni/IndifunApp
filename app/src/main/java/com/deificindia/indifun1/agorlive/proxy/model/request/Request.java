...
public class Request {
    ...
    public static final int ADD_BROADCAST = 20;
    public static final int INVITEUSERS = 21;
    public static final int INVITEDUSERS = 22;
    public static final int CHANGE_ONLINE_STATUS = 23;
    public static final int ISBROADCASTING_STATUS = 24;
    public static final int BROADCASTING_ROOM_ID = 25;
    public static final int UPDATE_BROADCASTING = 26;
