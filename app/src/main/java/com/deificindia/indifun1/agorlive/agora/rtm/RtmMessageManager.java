package com.deificindia.indifun1.agorlive.agora.rtm;
...
import com.deificindia.indifun1.agorlive.agora.rtm.model.ChatMessage;
...
import com.deificindia.indifun1.agorlive.agora.rtm.model.OwnerStateMessage;
import com.deificindia.indifun1.agorlive.agora.rtm.model.PKInvitationMessage;
import com.deificindia.indifun1.agorlive.agora.rtm.model.PKStateMessage;
import com.deificindia.indifun1.agorlive.agora.rtm.model.ProductStatedChangedMessage;
import com.deificindia.indifun1.agorlive.agora.rtm.model.SeatInteractionMessage;
...
public class RtmMessageManager implements RtmClientListener, RtmChannelListener {
    ...
    public static final int CHANNEL_MSG_TYPE_GIFT2 = 11;
    public static final int CHANNEL_MSG_TYPE_GIFT3 = 12;
    ...
    public void sendGiftMessage(String json, ResultCallback<Void> callback){
        sendChannelMessage(json, callback);
    }
            ...
            for (final RtmMessageListener listener : mMessageListeners) {
                switch (cmd) {
                    ...
                    case CHANNEL_MSG_TYPE_GIFT:
                        ...
                        break;
                    case CHANNEL_MSG_TYPE_GIFT2:
                        GiftMessage2 giftMessage2 = gson.fromJson(json, GiftMessage2.class);
                        //handleGiftMessage(listener, giftMessage2);
                        listener.onRtmGiftMessage2(giftMessage2.data);
                        break;
                    case CHANNEL_MSG_TYPE_GIFT3:
                        HeartGiftInfo giftMessage3 = gson.fromJson(json, HeartGiftInfo.class);
                        //handleGiftMessage(listener, giftMessage3);
                        listener.onRtmGiftMessage3(giftMessage3.data);
                        break;
