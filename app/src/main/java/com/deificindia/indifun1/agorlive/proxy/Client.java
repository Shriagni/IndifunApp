...
import com.deificindia.indifun1.agorlive.proxy.interfaces.GeneralService;
import com.deificindia.indifun1.agorlive.proxy.interfaces.PKService;
import com.deificindia.indifun1.agorlive.proxy.interfaces.ProductService;
import com.deificindia.indifun1.agorlive.proxy.interfaces.RoomService;
import com.deificindia.indifun1.agorlive.proxy.interfaces.SeatService;
import com.deificindia.indifun1.agorlive.proxy.interfaces.UserService;
...
import com.deificindia.indifun1.agorlive.proxy.model.body.PkRequestBody;
...
import io.agora.framework.BuildConfig;
    ...
    void enterRoom(long reqId, String token, String roomId) {
        mRoomService.requestEnterLiveRoom(token, reqId, Request.ENTER_ROOM, roomId).enqueue(new Callback<EnterRoomResponse>() {
            ...
            public void onResponse(Call<EnterRoomResponse> call, Response<EnterRoomResponse> response) {
                ...
                //Log.e("Main client enterRoom ", new Gson().toJson(enterRoomResponse));
                for (ClientProxyListener listener : mProxyListeners) {
