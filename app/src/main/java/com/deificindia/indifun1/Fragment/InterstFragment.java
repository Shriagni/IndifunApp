...
import com.deificindia.indifun1.pojo.getinterstsubcatlist.ResultItem;
...
public class InterstFragment extends Fragment {
    ...
    private class INterstSubCatlistadapter extends RecyclerView.Adapter<INterstSubCatlistadapter.ViewHolder> {
        ...
        @NonNull
        @Override
        public INterstSubCatlistadapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View v = null;
            ...
            return new INterstSubCatlistadapter.ViewHolder(v);
        }

        @Override
        public void onBindViewHolder(@NonNull INterstSubCatlistadapter.ViewHolder holder, final int position) {
        ...
        private void updateinterest(INterstSubCatlistadapter.ViewHolder holder,final int position1, final String langid) {
            Dialog myDialog;
            Progress_Dialogue DialogUtils = null;
            myDialog = DialogUtils.showProgressDialog(getActivity(), "Loading Please Wait...");
        ...
        private void uncheckinterest(INterstSubCatlistadapter.ViewHolder holder,final int position1, final String langid) {
            Dialog myDialog;
            Progress_Dialogue DialogUtils = null;
            myDialog = DialogUtils.showProgressDialog(getActivity(), "Loading Please Wait...");
