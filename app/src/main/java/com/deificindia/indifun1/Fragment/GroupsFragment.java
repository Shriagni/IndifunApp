...
import com.deificindia.indifun1.pojo.getgrouplistbycategory.ResultItem;
...
public class GroupsFragment extends Fragment {
    ...
    private class Grouplistadapter extends RecyclerView.Adapter<Grouplistadapter.ViewHolder> {
        ...
        @Override
        public void onBindViewHolder(@NonNull Grouplistadapter.ViewHolder holder, final int position) {
