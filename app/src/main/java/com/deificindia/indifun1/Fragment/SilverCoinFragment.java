...
public class SilverCoinFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_silvercoins, container, false);
    ...
    private void getsilvercoins() {

        myDialog = DialogUtils.showProgressDialog(getActivity(), "Loading Please Wait...");
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URLs.GETSILVERCOINS,
    ...
    private class GoldenCOinAdapter extends RecyclerView.Adapter<GoldenCOinAdapter.ViewHolder> {
        ...
        public GoldenCOinAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            ...
            v = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.silverlost_row, parent, false);
