...
import com.deificindia.indifun1.pojo.checkinmedalpojo.ResultItem;
...
public class SocialFragment extends Fragment {
    ...
    private ArrayList<com.deificindia.indifun1.pojo.sharelivemedal.ResultItem> resultItems2 = new ArrayList<>();
    private ArrayList<com.deificindia.indifun1.pojo.rechargemedal.ResultItem> resultItems3 = new ArrayList<>();
    ...
    private class CheckinMedalAdapter extends RecyclerView.Adapter<CheckinMedalAdapter.ViewHolder> {
        ...
        @NonNull
        @Override
        public CheckinMedalAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View v = null;
            ...
            return new CheckinMedalAdapter.ViewHolder(v);
        }

        @Override
        public void onBindViewHolder(@NonNull CheckinMedalAdapter.ViewHolder holder, final int position) {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (obj.optInt("status") == 1) {
                                ...
                                for (int i = 0; i < jsonObject.length(); i++) {
                                    JSONObject qstnArray = jsonObject.getJSONObject(i);
                                    com.deificindia.indifun1.pojo.sharelivemedal.ResultItem resultItem = new com.deificindia.indifun1.pojo.sharelivemedal.ResultItem();
                                    resultItem.setId(qstnArray.getString("id"));
                                    resultItem.setMedalCategory(qstnArray.getString("medal_category"));
                                    resultItem.setMedalSubcategory(qstnArray.getString("medal_subcategory"));
                                    resultItem.setProgressLimit(qstnArray.getString("progress_limit"));
                                ...
                                ArrayList<com.deificindia.indifun1.pojo.sharelivemedal.ResultItem> channelBeans = new ArrayList<>();
    ...
    private class ShareLiveAdapter extends RecyclerView.Adapter<ShareLiveAdapter.ViewHolder> {
        ...
        private ArrayList<com.deificindia.indifun1.pojo.sharelivemedal.ResultItem> shareitems = new ArrayList<>();
        private Context context;
        ...
        @NonNull
        @Override
        public ShareLiveAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View v = null;
            ...
            return new ShareLiveAdapter.ViewHolder(v);
        }

        @Override
        public void onBindViewHolder(@NonNull ShareLiveAdapter.ViewHolder holder, final int position) {
        ...
        public void addItem(ArrayList<com.deificindia.indifun1.pojo.sharelivemedal.ResultItem> channelBeans) {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (obj.optInt("status") == 1) {
                                ...
                                for (int i = 0; i < jsonObject.length(); i++) {
                                    JSONObject qstnArray = jsonObject.getJSONObject(i);
                                    com.deificindia.indifun1.pojo.rechargemedal.ResultItem resultItem = new com.deificindia.indifun1.pojo.rechargemedal.ResultItem();
                                    resultItem.setId(qstnArray.getString("id"));
                                    resultItem.setMedalCategory(qstnArray.getString("medal_category"));
                                    resultItem.setMedalSubcategory(qstnArray.getString("medal_subcategory"));
                                    resultItem.setProgressLimit(qstnArray.getString("progress_limit"));
                                ...
                                ArrayList<com.deificindia.indifun1.pojo.rechargemedal.ResultItem> channelBeans = new ArrayList<>();
    ...
    private class RechargeMedalAdapter extends RecyclerView.Adapter<RechargeMedalAdapter.ViewHolder> {
        ...
        private ArrayList<com.deificindia.indifun1.pojo.rechargemedal.ResultItem> rechargeitems = new ArrayList<>();
        private Context context;
        ...
        @NonNull
        @Override
        public RechargeMedalAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View v = null;
            ...
            return new RechargeMedalAdapter.ViewHolder(v);
        }

        @Override
        public void onBindViewHolder(@NonNull RechargeMedalAdapter.ViewHolder holder, final int position) {
        ...
        public void addItem(ArrayList<com.deificindia.indifun1.pojo.rechargemedal.ResultItem> channelBeans) {
