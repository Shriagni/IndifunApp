...
import com.deificindia.indifun1.pojo.getsilvrmedal.ResultItem;
...
public class GameFragment extends Fragment {
    ...
    private class SilverMedalAdapter extends RecyclerView.Adapter<SilverMedalAdapter.ViewHolder> {
        ...
        @NonNull
        @Override
        public SilverMedalAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View v = null;
            ...
            return new SilverMedalAdapter.ViewHolder(v);
        }

        @Override
        public void onBindViewHolder(@NonNull SilverMedalAdapter.ViewHolder holder, final int position) {
